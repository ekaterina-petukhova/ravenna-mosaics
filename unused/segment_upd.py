...
# ============================================================
# v6 — MULTI-SCALE CENTERS + LOCAL PERIMETERS + ULTRA JSON
# ============================================================

INPUT_IMAGE = "mosaic-higher-res.jpg"
OUTPUT_DIR = "tesserae_v6_output"
...
# Merge raw detections that are almost certainly the same center
RAW_CENTER_MERGE_RADIUS = 4.0
...
# If two accepted candidates describe nearly the same stone,
# merge them into one logical tessera.
DUPLICATE_CENTER_RADIUS = 7.0
DUPLICATE_COLOR_DISTANCE = 26.0
DUPLICATE_BBOX_IOU = 0.18
